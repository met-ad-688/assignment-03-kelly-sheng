...
fig.write_html("figures/Q4.html")
fig.write_image("figures/Q4.svg")

```
## Analysis
There doesn't seem to be a strong correlation between salary and remote work type; the variance for onsite 
